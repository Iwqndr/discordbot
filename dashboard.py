...
ROLE_LOCK_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "role_locks.json")
...
PERMISSIONS_FILE = os.path.join(os.path.dirname(__file__), "dash_permissions.json")
...
TICKET_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "tickets.json")
...
PROFILE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "member_profiles.json")
